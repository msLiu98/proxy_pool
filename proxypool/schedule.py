...
try:
    from aiohttp import ProxyConnectionError, ServerDisconnectedError, ClientResponseError, ClientConnectorError
except:
...
class ValidityTester(object):
    ...
    def set_raw_proxies(self, proxies):
        ...
        self._conn = RedisClient('proxies')
